...
ALLOWED_HOSTS = ['voting-app24-a24b376a0288.herokuapp.com', 'localhost', '127.0.0.1']
...
DATABASES = {
    ...
    # Uncomment this section if using MySQL
    # 'default': {
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # This line is important for Heroku
MEDIA_URL = '/media/'
